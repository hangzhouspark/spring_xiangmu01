...
<body>
<form action="/addExp.action" method="post" id="insertForm">
            ...
            <table id="ec_table" class="tableRegion" width="98%">
                ...
                <c:forEach items="${ExportList}" var="o" varStatus="status">
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                        <td><input type="checkbox" name="EXPORTPRODUCTID" value="${o.EXPORTPRODUCTID}"/></td>
                        ...
                        <td>${o.amount}</td>
                        <td>
                            <a href="/findExpByid.action?EXPORTPRODUCTID=${o.EXPORTPRODUCTID}">{修改}</a>
                            <a href="/delExp.action?EXPORTPRODUCTID=${o.EXPORTPRODUCTID}">{删除}</a>
                            <a href="#">{附件}</a>
                        </td>
                    </tr>
                </c:forEach>
